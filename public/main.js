...
function init() {
  ...
  ScheduleTemplate.prototype.openModal = function (target) {
    ...
    if (mq == 'mobile') {
      ...
      var modalWidth =
          windowWidth * 0.4 > self.modalMaxWidth
            ? self.modalMaxWidth
            : windowWidth * 0.8,
        modalHeight =
          windowHeight * 0.7 > self.modalMaxHeight
            ? self.modalMaxHeight
            : windowHeight * 0.7;
      ...
      var modalTranslateX = parseInt(
        ...
        modalTranslateY = parseInt((windowHeight - modalHeight) / 8 - eventTop);
